...
public class Calculadora extends JFrame implements ActionListener {
	...
	public void crear_Interface() {
		...
		boton_sumar.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 28));
		panel_operaciones.add(boton_sumar);
		
		boton_restar = new JButton("-");
		boton_restar.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 28));
		panel_operaciones.add(boton_restar);
		
		boton_multiplicar = new JButton("*");
		boton_multiplicar.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 28));
		panel_operaciones.add(boton_multiplicar);
		
		boton_dividir = new JButton("/");
		boton_dividir.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 28));
